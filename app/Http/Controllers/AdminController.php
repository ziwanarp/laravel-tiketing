...
class AdminController extends Controller
{
    ...
    public function pemesanan_update(Request $request, Tiket $tiket)
    {
        ...
        // create logs
        Log::create(['user' => auth()->user()->name, 'aksi' => 'Update tiket ' . $tiket->id_tiket]);
    ...
    {
        // create logs
        // Log::create(['user' => auth()->user()->name, 'aksi' => 'Hapus tiket ' . $tiket->id_tiket]);

        // Tiket::destroy($tiket->id);
        Tiket::where('id_tiket', $tiket->id_tiket)->update(['tampilkan' => '1']);
    ...
    public function checkin_checkin(Tiket $tiket)
    {
        ...
        // create logs
        Log::create(['user' => auth()->user()->name, 'aksi' => 'Check-in tiket ' . $tiket->id_tiket]);
